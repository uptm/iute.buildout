...
ztc.installProduct('iute.thememain')
...
def setup_product():
    ...
    import iute.themebase
    zcml.load_config('configure.zcml', iute.thememain)
...
setup_product()
ptc.setupPloneSite(products=['iute.thememain'])
...
class FunctionalTestCase(ptc.FunctionalTestCase):
    ...
    def afterSetUp(self):
        ...
        self.portal.use_iute_home_url = False
