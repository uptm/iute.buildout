...
from iute.default.config import DEPENDENCIES
from Products.GenericSetup import interfaces as gsinterfaces
from zope import component
from config import iute_cache_policies, cache_type_mappings
...
def add_cache_policies(portal):
    ...
    for policy_id, policy_settings in iute_cache_policies.items():
...
def import_all(context):
    ...
    if not context.readDataFile('iute.default.txt'):
        return
