...
from iute.requirements.golivechecks import CheckMustClickReadyToGoLive
...
class IUTERequirementsConfiglet(BrowserView):
    ...
    template = ViewPageTemplateFile('iute-requirements.pt')
    errormsg = ""
...
Email: %s
            ...
            self.request.response.redirect(url + '/@@iute-requirements')
